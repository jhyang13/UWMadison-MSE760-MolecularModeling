...
srun --mpi=pmix -n ${SLURM_NTASKS} pw.x < alas.scf.in > alas.scf.out
srun --mpi=pmix -n ${SLURM_NTASKS} ph.x < alas.phG.in > alas.phG.out
srun --mpi=pmix -n ${SLURM_NTASKS} dynmat.x < alas.dynmat.in > alas.dynmat.out
