...
srun --mpi=pmix -n ${SLURM_NTASKS} ph.x < si.phX.in > si.phX.out
srun --mpi=pmix -n ${SLURM_NTASKS} ph.x < si.ph.in > si.ph.out 
srun --mpi=pmix -n ${SLURM_NTASKS} q2r.x < q2r.in > q2r.out
srun --mpi=pmix -n ${SLURM_NTASKS} matdyn.x < matdyn_ex.in > matdyn_ex.out
